  ...
  return (
    <div className="space-y-16 py-6">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        {/* Traditional */}
        <div className="rounded-3xl border border-red-500/20 dark:border-red-500/30 bg-white dark:bg-[#202B25]/40 p-6 space-y-4 shadow-md">
          <div className="flex items-center gap-2.5">
            <XCircle className="h-5 w-5 text-red-500" />
            <h3 className="font-heading text-base font-bold text-slate-900 dark:text-white">Traditional Trackers</h3>
          </div>
          <ul className="space-y-2.5 text-xs text-slate-600 dark:text-slate-300 font-medium">
            <li className="flex items-center gap-2"><span className="text-red-500 font-bold">✕</span> Streak resets to zero on 1 miss</li>
            <li className="flex items-center gap-2"><span className="text-red-500 font-bold">✕</span> Guilt & habit abandonment</li>
            <li className="flex items-center gap-2"><span className="text-red-500 font-bold">✕</span> Ignores why you missed</li>
          </ul>
        </div>

        {/* Habit Rescue */}
        <div className="rounded-3xl border border-[#659F84]/40 dark:border-[#659F84]/50 bg-white dark:bg-[#202B25] p-6 space-y-4 shadow-lg glow-emerald">
          <div className="flex items-center gap-2.5">
            <Sprout className="h-5 w-5 text-[#659F84]" />
            <h3 className="font-heading text-base font-bold text-slate-900 dark:text-white">Habit Rescue</h3>
          </div>
